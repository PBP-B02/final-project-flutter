...
List<MyIncome> myIncomeFromJson(String str) => List<MyIncome>.from(json.decode(str).map((x) => MyIncome.fromJson(x)));

String myIncomeToJson(List<MyIncome> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
final modelValues = EnumValues({
    "cashflow.income": Model.CASHFLOW_INCOME
});
