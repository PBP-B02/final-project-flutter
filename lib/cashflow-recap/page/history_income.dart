...
import 'package:catfish/cashflow-recap/util/fetch_income.dart';
...
class HistoryIncomePage extends StatefulWidget {
  const HistoryIncomePage({super.key, this.bulan});

  final int? bulan;

  @override
  State<HistoryIncomePage> createState() => _HistoryIncomePageState();
}

class _HistoryIncomePageState extends State<HistoryIncomePage> {
                        ...
                        builder: (context, AsyncSnapshot snapshot) {    
                          if (snapshot.data == null) {
                            ...
                            for (var i = 0; i < snapshot.data!.length; i++) {
                              if (snapshot.data![i].fields.date.month == widget.bulan) {
